...
@section('content')
    ...
    @endif
        <div class="row">
            <div class="col-md-12">
                <h1>{{__('wanoarea')}}</h1>
                <form method="POST" action="{{ route('wanoarea.store') }}">
                    ...
                    <div class="form-group">  
                        ...
                        <input type="text" class="form-control" id="abv" name="abv" placeholder="{{__('Enter abv')}}">
                    </div>
                    <div class="form-group">  
                        <label for="focus">{{__('focus')}}</label>
                        <input type="text" class="form-control" id="focus" name="focus" placeholder="{{__('Enter focus')}}">
                    </div>
